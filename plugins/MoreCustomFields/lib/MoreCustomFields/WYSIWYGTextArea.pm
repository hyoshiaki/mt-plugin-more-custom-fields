...
sub _field_html {
    return q{
<script src="<mt:Var name="static_uri">plugins/morecustomfields/ckeditor/ckeditor.js"></script>
<script src="<mt:Var name="static_uri">plugins/morecustomfields/ckeditor/adapters/jquery.js"></script>
<script>
